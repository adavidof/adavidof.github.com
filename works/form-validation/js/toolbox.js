...
// classNameToggle, cross-browser compatibility(ie9, ff, opera, chrome), write on default className
function TBclassNameToggle(el, className, option) {
    ...
    } else if (elSplitindexOf === -1) {
        spaceBefore = (elSplitArr.length > 0 && elSplitArr[0] !== '') ? ' ' : '';
    } else {
